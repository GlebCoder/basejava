...
- Реализуйте методы `save, get, delete, clear, getAll, size` в классе `com.basejava.webapp.storage.ArrayStorage`,
...
- Проверьте вашу реализацию с помощью классов `com.basejava.webapp.MainArray.main()`
  и `com.basejava.webapp.MainTestArrayStorage.main()`
...
1. В методе `clear()` обнуление массива предполагает обнуление (null) ячеек, где хранятся
   com.basejava.webapp.model.Resume, а не создание нового или присваивание ему null
...
1. com.basejava.webapp.model.Resume r — давайте переменным осмысленные имена, например resume. r допустимо в коротких
